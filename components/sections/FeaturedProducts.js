        ...
        <div className="sm:flex justify-between items-end mb-10">
          <div>
            <h2 className="text-4xl font-extrabold text-gray-900">
              New <span className="text-[var(--primary)]">Drops</span>
            </h2>
            <p className="text-gray-600 mt-2">
              Fresh styles our community is loving right now
            </p>
          </div>

          <Link
            href="/shop"
            className="flex items-center gap-2 text-[var(--primary)] font-semibold"
          >
